...
describe('CustomersRepositoryImpl', () => {
  describe('findByFilter', () => {
    ...
    it('should return customers from random user with name and lastname filter', async () => {
      // Prepare
      const repository = new CustomersRepositoryImpl();
    ...
    it('should return customers from random user with name and lastname filter and no results', async () => {
      // Prepare
      const repository = new CustomersRepositoryImpl();
